# Deploys VCF Operations for Networks on a different network than that used for VCF Management VMs.
# Variation from William Lam's script to deploy VCF Operations for Networks via Fleet Manager APIs
# https://github.com/lamw/vmware-scripts/blob/master/powershell/fleet_lcm_deploy_vcf_automation_to_different_network.ps1

# VCF Instance Name
$VCFInstanceName = "vcfsddc"

# VCF Management Services (VCFMS) Crededntials
$VCFManagementServicesPassword = "VMware1!VMware1!"
$VCFManagementServicesRuntimeFQDN = "vcfsruntime.br00mwalker.net"
$VCFManagementServicesFleetFQDN = "vcfsfleet.br00mwalker.net"
$VCFNetworkOpsVersion = "9.1.0.0"
$VCFNetworkOpsAppliancePassword = "VMware1!VMware1!"
$VCFNetworkOpsAdminPassword = "VMware1!VMware1!"
$VCFNetworkOpsPlatformFQDN = "ward.br00mwalker.net"
$VCFNetworkOpsCollectorFQDN = "layth.br00mwalker.net"
$VCFNetworkOpsDeploymentSize = "small"
$VCFNetworkOpsDNS = "192.168.127.1"
$VCFNetworkOpsNTP = "192.168.127.1"
$VCFNetworkOpsSuffix = "br00mwalker.net"
$VCFNetworkOpsNetworkName = "SDDC-BRM-DPortGroup-VM-Mgmt-Extended"
$VCFNetworkOpsNetworkGateway = "192.168.125.254"
$VCFNetworkOpsNetworkNetmask = "255.255.255.0"
$VCFNetworkOpsPlatformIPAddress = "192.168.125.13"
$VCFNetworkOpsCollectorIPAddress = "192.168.125.14"




$ValidateOnly = $true # change to false to deploy
$OutputJsonPayload = $true # change to true to output to PS console (can be used without deployment)
  ...
  "componentSpecs": [
    {
      ...
      "nodeSpecs": [
        {
          "nodeType": "PLATFORM",
          "version": "$VCFNetworkOpsVersion",
          "deploymentSpec": {
            "fqdn": "$VCFNetworkOpsPlatformFQDN",
            "password": "$VCFNetworkOpsAppliancePassword",
            "deploymentOption": "$VCFNetworkOpsDeploymentSize",
            "dnsServers": "$VCFNetworkOpsDNS",
            "ntpServers": "$VCFNetworkOpsNTP",
            "dnsSuffix": "$VCFNetworkOpsSuffix",
            "ipv4Settings": {
              "addressType": "Static",
              "address": "$VCFNetworkOpsPlatformIPAddress",
              "gateway": "$VCFNetworkOpsNetworkGateway",
              "netmask": "$VCFNetworkOpsNetworkNetmask"
            },
            "networkName": "$VCFNetworkOpsNetworkName"
          }
        },
        {
          "nodeType": "COLLECTOR",
          "version": "$VCFNetworkOpsVersion",
          "deploymentSpec": {
            "fqdn": "$VCFNetworkOpsCollectorFQDN",
            "password": "$VCFNetworkOpsAppliancePassword",
            "deploymentOption": "$VCFNetworkOpsDeploymentSize",
            "dnsServers": "$VCFNetworkOpsDNS",
            "ntpServers": "$VCFNetworkOpsNTP",
            ...
            "ipv4Settings": {
              "addressType": "Static",
              "address": "$VCFNetworkOpsCollectorIPAddress",
              "gateway": "$VCFNetworkOpsNetworkGateway",
              "netmask": "$VCFNetworkOpsNetworkNetmask"
            },
            "networkName": "$VCFNetworkOpsNetworkName"
      ...
      "configSpec": {
        "adminPassword": "$VCFNetworkOpsAdminPassword"
      }
    }
  ]
}
...
if($ValidateOnly -eq $false) {
    My-Logger "Starting VCF Operations for Networks Deployment to alternative network ${VCFManagementServicesNetworkName} ..."
    $connectivityParams = @{
